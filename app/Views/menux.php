        ...
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    <li class="nav-item">
                        <a href="http://meganerura.site/hospital/public/"
                            class="nav-link align-middle px-0 custom-link">
                    ...
                    <li>
                        <a href="<?=base_url('verPacientes')?>" class="nav-link px-0 align-middle custom-link">
                            <i class="bi bi-person-fill-gear"></i> <span
                                class="ms-1 d-none d-sm-inline">Administración</span></a>
                    </li>
                    ...
                    <li>
                        <a href="<?=base_url('irmenucobros')?>" class="nav-link px-0 align-middle custom-link">
                            <i class="bi bi-credit-card-2-back"></i> <span
                                class="ms-1 d-none d-sm-inline">Cobros</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="<?=base_url('irmenucontabilidad')?>" class="nav-link px-0 align-middle custom-link">
                            <i class="bi bi-journal-check"></i> <span
                                class="ms-1 d-none d-sm-inline">Contabilidad</span></a>
                    </li>
                    <li>
