...
<html lang="es">
  ...
  <h1>Departamentos</h1>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <select class="form-select" aria-label="Default select example" name="lst_region" required>
                                  // <?php
                                     foreach ($resultadoregiones as $region) {
                                    ?>
    ...
    <table class="table table-hover table-striped" id="dataTable">
        ...
        <tbody>
            <?php 
                foreach($resultadoDepartamento as $datos){
            ?>
            <tr>
                ...
                <td><a
                                    href="<?=base_url("localizar_modificar_departamento/".$datos['cod_depto'])?>"><button type="button" class="btn btn-warning">Actualizar <i class="bi bi-pencil-square"></i> </button></a>
                                
                                <a href="<?=base_url("eliminar_departamento/".$datos['cod_depto'])?>"><button type="button" class="btn btn-danger">Eliminar <i class="bi bi-trash3"></i></button></a>
                            </td>
