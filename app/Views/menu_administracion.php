        ...
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        <a href="<?=base_url('verRegiones')?>" class="nav-link px-0 align-middle custom-link">
                            <i class="bi bi-person-fill-gear"></i> <span class="ms-1 d-none d-sm-inline">Administración</span></a>
                    </li>

                    <li>
                        <a href="<?=base_url('verRegiones')?>" class="nav-link px-0 align-middle custom-link">
                            <i class="bi bi-paperclip"></i> <span class="ms-1 d-none d-sm-inline">Parametrización</span></a>
                    </li>
                    ...
                    <li>
                        <a href="<?=base_url('verRegiones')?>" class="nav-link px-0 align-middle custom-link">
                            <i class="fs-4 bi-table"></i> <span class="ms-1 d-none d-sm-inline">Mantenimiento de Usuario</span></a>
                    </li>
                    <li>
                        <a href="<?=base_url('verRegiones')?>" class="nav-link px-0 align-middle custom-link">
                            <i class="bi bi-cart-plus"></i> <span class="ms-1 d-none d-sm-inline">Permisos de Usuarios</span></a>
                    </li>
