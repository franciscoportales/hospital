...
<body>
                        ...
                        <select class="form-select" name="lst_estado">
                            <?php
                                      foreach ($resultadoestadocivil as $estadocivil) {
                                        ?>
                            <option value="<?= $estadocivil['cod_estado_civil'] ?>">
                                <?= $estadocivil['estado_civil'] ?> </option>
                            <?php
                                         }
         ?>
                        </select>
 ...
 foreach ($resultadoprofesiones as $profesion) {
     ...
     ?>
                            <option value="<?= $profesion['cod_profesion'] ?>">
                                <?= $profesion['profesion'] ?>
                            </option>
                            <?php
     }
         ?>
                ...
                <div class="mb-3" style="display: flex;">
                    ...
                    <div style="margin-right: 10px;">
                        ...
                        <input type="text" class="form-control" id="txtpadre" name="txtmadre" placeholder="txtmadre">
                    </div>

                    <div style="margin-right: 10px;">
                        <label for="txtcuim" class="form-label">Cui Madre:</label>
                        <input type="text" class="form-control" id="txtcuim" name="txtcuim" placeholder="cuim">
                    </div>
                    ...
                    <div style="margin-right: 10px;">
                        ...
                        <input type="text" class="form-control" id="txtconyuge" name="txtconyuge"
                            placeholder="txtconyuge">
                    </div>

                    <div style="margin-right: 10px;">
                        <label for="txtcuic" class="form-label">Cui Conyuge:</label>
                        <input type="text" class="form-control" id="txtcuic" name="txtcuic" placeholder="cui conyugue">
                    </div>
